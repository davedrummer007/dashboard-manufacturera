// app/dashboard/modulo-b/capitulo-2/components/DataFilters.tsx
"use client";
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 truncate">
            Gestión seleccionada: <span className="font-semibold text-green-600 dark:text-green-400">{gestion}</span>
          </p>
        </div>
        ...
        <div className="flex items-center space-x-3 flex-shrink-0">
          ...
          <select
            ...
            className={`px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm font-medium whitespace-nowrap ${
              darkMode 
