...
export const getPreguntaChartData = (gestion: string, pregunta: string): PreguntaChartData => {
  ...
  return {
    ...
    series: [preguntaData.si, preguntaData.no, preguntaData.sinRespuesta],
    colors: ['#322a9dff', '#39e6a4ff', '#6B7280']
  }
}
...
export const getPreguntaTitulo = (pregunta: string): string => {
  const titulos: { [key: string]: string } = {
    'preg_1': 'ADOPCIÓN DE SISTEMAS DE GESTIÓN INTEGRADA (ISO 9001, 14001, u otros.)',
    'preg_4': 'UNIDADES ECONÓMICAS CON CERTIFICACIÓN DE PRODUCTOS',
    'preg_6': 'UNIDADES ECONÓMICAS CON SELLO HECHO EN BOLIVIA',
    'preg_7': 'UNIDADES ECONÓMICAS CON SELLO SOCIAL BOLIVIANO'
  }
