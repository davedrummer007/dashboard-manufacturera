...
export const getPreguntaTitulo = (pregunta: string): string => {
  const titulos: { [key: string]: string } = {
    'p1': 'UNIDADES ECONÓMICAS QUE CUENTAN CON EQUIPOS DE INNOVACIÓN',
    'p4': 'UNIDADES ECONÓMICAS CON METODOLOGÍAS DE INNOVACIÓN',
    'p6': 'UNIDADES ECONÓMICAS QUE PATENTARON SU INNOVACIÓN'
  }
