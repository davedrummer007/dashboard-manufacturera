      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex-1 min-w-0">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white truncate">
            🏢 Dashboard de Activos Fijos - Micro/Pequeña/Mediana Empresa
          </h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 truncate">
            Gestión seleccionada: <span className="font-semibold text-orange-600 dark:text-orange-400">{gestion}</span>
          </p>
        </div>
        ...
        <div className="flex items-center space-x-3 flex-shrink-0">
          ...
          <select
            ...
            className={`px-3 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-sm font-medium whitespace-nowrap ${
              darkMode 
