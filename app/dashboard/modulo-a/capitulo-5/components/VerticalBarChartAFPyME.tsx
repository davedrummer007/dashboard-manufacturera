...
interface VerticalBarChartAFPyMEProps {
  data: ActivosFijosPyMEData[]
  gestion: string
  darkMode: boolean
}

const VerticalBarChartAFPyME: React.FC<VerticalBarChartAFPyMEProps> = ({ data, gestion, darkMode }) => {
  // Ordenar datos por valor contable descendente
  const sortedData = [...data].sort((a, b) => b.valorContable - a.valorContable)
  
  // Paleta de colores para PyME (tonos más cálidos)
  const pymeColors = [
    '#f8752fff', '#0fe9e9ff', '#7d3ceeff', '#f5ff66ff', '#88D3A8',
    '#F78C6B', '#4FB0C6', '#C989E4', '#FFB347', '#7BC8A4'
  ]
...
export default VerticalBarChartAFPyME