...
const DataFilters: React.FC<DataFiltersProps> = ({ gestion, onGestionChange, darkMode }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-4 mb-4"> {/* Reducido mb-6 a mb-4 */}
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4"> {/* Agregado gap-4 */}
        <div className="flex-1 min-w-0">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white truncate">
            📊 Dashboard Manufacturero
          </h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 truncate">
            Gestión seleccionada: <span className="font-semibold">{gestion}</span>
          </p>
        </div>
