...
import PieChart3DReal from './components/PieChart3DReal'
      ...
      <div className="space-y-6">    
        ...
        >
          <h3 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">
            DISTRIBUCION DEPARTAMENTAL DE LOS INGRESOS MANUFACTUREROS <br />
          ...
          >
            <h3 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white text-justify">
              INGRESOS POR VENTAS DEL SECTOR MANUFACTURERO POR TIPO DE SOCIEDAD <br />
              (En Porcentajes)
            </h3>
            <PieChart3DReal 
              data={societario}
