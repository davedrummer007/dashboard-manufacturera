...
export const getPreguntaTitulo = (pregunta: string): string => {
  const titulos: { [key: string]: string } = {
    'p1': 'UNIDADES ECONÓMICAS CON PCS DE ESCRITORIO',
    'p2': 'UNIDADES ECONÓMICAS CON DISPOSITIVOS MOVILES (LAPTOPS)',
    'p3': 'UNIDADES ECONÓMICAS CON ACCESO A INTERNET',
    'p4': 'UNIDADES ECONÓMICAS CON SITIO WEB PROPIO',
    'p5': 'UNIDADES ECONÓMICAS CON REDES SOCIALES (FACEBOOK, TWITTER, INSTAGRAM)',
    'p6': 'UNIDADES ECONÓMICAS QUE INVIERTEN EN PUBLICIDAD DIGITAL',
    'p7': 'UNIDADES ECONÓMICAS QUE REALIZAN COMPRAS POR INTERNET',
    'p8': 'UNIDADES ECONÓMICAS QUE REALIZAN VENTAS POR INTERNET',
    'p9': 'UNIDADES ECONÓMICAS QUE UTILIZAN INTERNET PARA SERVICIOS FINANCIEROS/BANCARIOS',
    'p10': 'UNIDADES ECONÓMICAS QUE CUENTAN CON HABILITACION DE TELETRABAJO/TRABAJO REMOTO',
    'p11': 'UNIDADES ECONÓMICAS QUE CUENTAN CON SISTEMAS DE GESTION INTEGRADA'
  }
